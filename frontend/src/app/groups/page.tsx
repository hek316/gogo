    ...
    <div className="min-h-screen bg-bg">
      <header className="bg-bg border-b border-border sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-3">
          <button onClick={() => router.push('/places')} aria-label="뒤로 가기" className="text-text-muted hover:text-text-main">
      ...
      <main className="max-w-md mx-auto px-4 py-10">
        <div role="tablist" aria-label="그룹 메뉴" className="flex bg-surface rounded-[16px] p-1 mb-8">
        ...
        {tab === 'create' ? (
          <form onSubmit={handleCreate} className="space-y-4">
            <div>
              ...
              <input required placeholder="예) 성수동 탐방대…" name="groupName" autoComplete="off"
          ...
          <form onSubmit={handleJoin} className="space-y-4">
            <div>
              ...
              <input required placeholder="8자리 코드 입력…" name="inviteCode" autoComplete="off" spellCheck={false}
