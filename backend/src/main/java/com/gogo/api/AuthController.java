...
import com.gogo.domain.service.AuthService;
import com.gogo.domain.usecase.KakaoLoginUseCase;
import com.gogo.domain.usecase.GoogleLoginUseCase;
import com.gogo.domain.usecase.RefreshTokenUseCase;
...
public class AuthController {
    ...
    public void authorize(HttpServletResponse response) throws Exception {
        response.sendRedirect(authService.getKakaoAuthUrl());
    }
    ...
    public void googleAuthorize(HttpServletResponse response) throws Exception {
        response.sendRedirect(authService.getGoogleAuthUrl());
    }
